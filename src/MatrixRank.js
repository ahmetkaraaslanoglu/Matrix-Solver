    ...
    return(
        <View style={{flex:1}}>
            ...
            <View style={{flex:1,backgroundColor:'black',justifyContent:'center',alignItems:'center',flexDirection:'row'}}>
                ...
                <Text style={{color:'white',fontSize:24}}>Matrix Rank</Text>
            </View>
            ...
            <View style={{flex:1,backgroundColor:'white',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                <TouchableOpacity
                    ...
                    onPress={()=> {
                        setSolution(matrixRank(matrixArr));

                    }}>
                    <Text style={{color:'white',fontSize:18}}>Matrisin rankını hesapla</Text>
                </TouchableOpacity>
            </View>
